...
<div class="main-header">
    ...
    <p>Tác giả: Hỏa Thị Liễu - Trường Tiểu học Quyết Tiến - ĐT: 097 3567 073</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hỏa Thị Liễu - Trường Tiểu học Quyết Tiến - ĐT: 097 3567 073</div>", unsafe_allow_html=True)
